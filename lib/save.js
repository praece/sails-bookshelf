...
module.exports = function save(attrs, options = {}) {
  ...
  return Promise.resolve()
    ...
    .then(method => {
      ...
      // Don't include updatedAt since that has always changed
      options.changed = _.omit(_.cloneDeep(this.changed), ['updatedAt']);
    ...
    .tap(model => {
      ...
      options.previousAttributes = _.omit(this._previousAttributes, ['updatedAt']);
